 ...
 * @returns {Promise}
 */
Resource.prototype.list = function( req ) {
    var q,
        f,
        query,
        deferred;
    ...
    // Normalize
    query = this._normalize( req.query, this.opts );

    // Filter
    f = filter( query.filter ).where( this._params( req.params, this.opts.map ) );
 ...
 * @returns {Promise}
 */
Resource.prototype.read = function( req ) {
    var q,
        qo,
        query,
        deferred;
    ...
    // Query Options
    qo[this.opts.idAttribute] = req.params.id;
 ...
 * @returns {Promise}
 */
Resource.prototype.create = function( req ) {
    var deferred,
        query;
 ...
 * @returns {Promise}
 */
Resource.prototype.update = function( req ) {
    var q,
        qo,
        query,
        deferred;
 ...
 * @returns {Promise}
 */
Resource.prototype.delete = function( req ) {
    var qo,
        deferred;
